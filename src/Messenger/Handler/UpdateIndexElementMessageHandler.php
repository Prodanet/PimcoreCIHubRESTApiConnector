...
final readonly class UpdateIndexElementMessageHandler implements MessageHandlerInterface
{
     ...
     * @throws \Exception
     */
    public function incrementProgress(UpdateIndexElementMessage $updateIndexElementMessage): void
    {
     ...
     */
    public function switchNewIndexToAlias(UpdateIndexElementMessage $updateIndexElementMessage): void
    {
